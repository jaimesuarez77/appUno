...
const RegisterReservas = ({navigation})=>{
  ...
  return <View style = {GeneralStyles.container}>
     ...
     <ScrollView >  
        ...
        <TextInput placeholder = 'Teléfono' style = {GeneralStyles.inputData}  onChangeText={(text)=>setTelefonoCliente(text)}></TextInput>
        <TextInput placeholder = 'Fecha de Inicio' style = {GeneralStyles.inputData}  onChangeText={(text)=>setFechaInicio(text)}></TextInput>
        <TextInput placeholder = 'Fecha Final' style = {GeneralStyles.inputData}  onChangeText={(text)=>setFechaFinal(text)}></TextInput>
        <TextInput placeholder = 'Número de personas' style = {GeneralStyles.inputData}  onChangeText={(text)=>setNumerodePersonas(text)}></TextInput>
